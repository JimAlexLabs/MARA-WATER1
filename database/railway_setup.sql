-- MARA-WATER schema + seed, adjusted for a pre-created database (Railway MySQL).
-- Generated from mara_water_complete_all_modules.sql with CREATE DATABASE / USE removed.
-- Load with:  mysql -h HOST -P PORT -u USER -pPASS DBNAME < database/railway_setup.sql
